        ...
        return (
          <section className="step active">
            ...
            <div className="grid">
              ...
              <div className="field"><label>Straße <span className="req">*</span></label><input ref={streetRef} type="text" autoComplete="off" className={ff("patient_strasse").trim()} value={txt("patient_strasse")} onChange={(e) => set("patient_strasse", e.target.value)} />{gruende["patient_strasse"] ? <span className="fehlt-grund">{gruende["patient_strasse"]}</span> : null}</div>
