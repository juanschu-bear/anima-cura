...
export default function LoginForm() {
  ...
  const statusMessage = useMemo(() => {
    ...
    if (reason === "logout") return "Du wurdest erfolgreich abgemeldet.";
    return "";
  }, [reason]);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Block patient accounts from the praxis (software) login
    const {
      data: { user: authUser },
    ...
    if (authUser) {
      ...
      if (role === "patient") {
        ...
        setError("Dieses Konto ist ein Patienten-Zugang. Bitte nutze das Patientenportal.");
        setLoading(false);
        return;
      }
    }
  ...
  return (
    <div className="acl-root">
        ...
        <motion.div className="acl-login" variants={item}>
          <div className="acl-card">
            ...
            <div className="acl-card-head">
              ...
              <p className="acl-brand-tag">Revenue Protection &amp; Customer Retention Portal</p>
            </div>

            <div className="acl-divider" aria-hidden="true" />

            <h2 className="acl-title">Willkommen zurück</h2>
            <p className="acl-subtitle">Melde dich mit deinem Praxis-Zugang an</p>

            {statusMessage && (
              <div className="acl-info" role="status" aria-live="polite">
                <Info size={16} strokeWidth={2} className="acl-error-icon" aria-hidden="true" />
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="acl-field">
                <label htmlFor="login-email" className="acl-label">
                  E-Mail
                </label>
              ...
              {/* Password */}
              <div className="acl-field">
                <label htmlFor="login-password" className="acl-label">
                  Passwort
                </label>
                <div className="acl-input-wrap">
          ...
          <p className="acl-foot">
            ...
            Geschützter Bereich für Praxisleitung, Verwaltung &amp; Team.
          </p>
        </motion.div>
      </motion.div>
      ...
      <style
        ...
        .acl-brand-tag {
          margin: 6px 0 0; font-size: 10.5px; font-weight: 600;
          text-transform: uppercase; letter-spacing: 0.22em; color: #7fd8a8;
          line-height: 1.5;
        }
        .acl-divider {
        ...
        /* ---------- Info (session expired / logged out) ---------- */
        .acl-info {
          display: flex; align-items: center; gap: 8px;
          background: rgba(34,197,94,0.08);
          border: 1px solid rgba(34,197,94,0.3);
          border-radius: 12px; padding: 12px 14px; margin-bottom: 20px;
          font-size: 13px; color: #9fe6bd;
        }
