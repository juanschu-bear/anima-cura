...
export default function ScribeCockpit({ nutzerName }: { nutzerName: string }) {
  ...
  function leistungToggle(slug: string) {
    bearbeitet();
    setGewaehlt((alt) => {
      // bereits aktiv: abwaehlen, aber mindestens eine bleibt
      ...
      // Gleiche Phase: dazunehmen (echte Kombi, z. B. Bogenkontrolle + IP).
      // Andere Phase: ersetzen (eine Diagnostik wird nicht zur Verlaufskontrolle).
        ...
        {(() => {
          ...
          const Karte = (e: TagesEintrag) => {
            ...
            const am = e.bestaetigt_am
              ...
              : "·";
            const pushFehlerHinweis = e.ivoris_push_status === "fehler" ? beschreibePushFehlerPraxis(e.ivoris_fehler) : null;
            return (
            ...
            <div className="detailkarte" onClick={(ev) => ev.stopPropagation()}>
              ...
              {detail.ivoris_push_status === "fehler" && (
                <p className="detailfehlerbox">
                  <b>Hinweis:</b> Das ist kein Praxisfehler.
                  {" "}
