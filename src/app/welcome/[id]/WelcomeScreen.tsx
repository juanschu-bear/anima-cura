...
const T: Record<string, Record<string, string | string[]>> = {
  ...
  ru: {
    thanks: "Спасибо",
    received: "Твоя анкета получена. Подписанные документы придут на электронную почту.",
    next: "Что дальше?",
    appTitle: "Твоё приложение Anima Cura",
    appDesc: "Теперь у тебя есть собственное защищённое пространство.",
    f1: "Все счета и платёжные планы",
    f2: "Твои документы",
    f3: "Обзор этапов лечения",
    f4: "Твои рассрочки",
    f5: "Сообщения от клиники",
    cred: "Твои данные для входа",
    credTitle: "\ud83d\udd11 Твои логин-данные",
    email: "E-mail",
    pw: "Пароль",
    pwTap: "\ud83d\udc46 Нажми, чтобы показать",
    pwHide: "Скрыть",
    sec: "@animacura.de — внутренняя система клиники.",
    screenshot: "Сделай скриншот или сохрани эту страницу.",
    open: "Открыть",
    qrTitle: "\ud83d\udcf1 Сканировать",
    qrDesc: "Отсканируй QR-код.",
    qrHint: "Открой камеру.",
    btnTitle: "\ud83d\udc46 Открыть",
    btnDesc: "Уже на телефоне?",
    btnText: "Открыть Anima Cura",
    guideTitle: "Начинаем!",
    guideSub: "Установка на домашний экран",
  ...
  tr: {
    thanks: "Teşekkürler",
    received: "Anamnez formun bize ulaştı. Muayenehanemiz her şeyi kayıt altına aldı.",
    next: "Sırada ne var?",
    appTitle: "Anima Cura Uygulaman",
    appDesc: "Artık tedavinle ilgili her şeyi bulabileceğin kendi güvenli alanın var.",
    f1: "Tüm faturalar ve ödeme planları",
    f2: "Belgelerin",
    f3: "Tedavi aşamaları",
    f4: "Taksit ödemelerin",
    f5: "Mesajlar",
    cred: "Giriş bilgilerin",
    credTitle: "\ud83d\udd11 Giriş bilgilerin",
    email: "Giriş e-postası",
    pw: "Şifre",
    pwTap: "\ud83d\udc46 Görmek için dokun",
    pwHide: "Gizle",
    sec: "@animacura.de dahili bir muayenehane sistemidir.",
    screenshot: "Bu sayfayı kaydet veya ekran görüntüsü al.",
    open: "Uygulamayı aç",
    qrTitle: "\ud83d\udcf1 Telefonla tara",
    qrDesc: "QR kodu telefonunla tara.",
    qrHint: "Kamerayı aç.",
    btnTitle: "\ud83d\udc46 Doğrudan aç",
    btnDesc: "Zaten telefondaysan?",
    btnText: "Anima Cura aç",
    guideTitle: "Haydi başlayalım!",
    guideSub: "Uygulamayı ana ekranına kur",
    ...
    appNote: "\ud83d\udccc Almanca, İngilizce ve İspanyolca.",
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "14px 22px 60px" }}>
        <div style={{ position: "relative", background: "linear-gradient(180deg,#fdfbf7,#f8f5ef)", border: "1px solid rgba(29,42,39,0.10)", borderRadius: 16, padding: "32px 28px", boxShadow: "0 26px 60px -34px rgba(40,55,50,0.4)", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 6, flexWrap: "wrap", margin: "18px 0 8px" }}>
            {([["de", "\ud83c\udde9\ud83c\uddea Deutsch"], ["en", "\ud83c\uddec\ud83c\udde7 English"], ["es", "\ud83c\uddea\ud83c\uddf8 Espa\u00f1ol"], ["ru", "\ud83c\uddf7\ud83c\uddfa \u0420\u0443\u0441\u0441\u043a\u0438\u0439"], ["tr", "\ud83c\uddf9\ud83c\uddf7 T\u00fcrk\u00e7e"]] as const).map(([l, label]) => (
